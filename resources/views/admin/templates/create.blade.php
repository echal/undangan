                ...
                <form action="{{ route('admin.templates.store') }}" method="POST"
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                               ...
                               placeholder="cth: Elegant Rose">
                        <p class="text-xs text-gray-400 mt-1">Slug akan dibuat otomatis dari nama template.</p>
                        @error('name')
                    ...
                    <div>
                        ...
                        <select name="event_type"
                            ...
                            <option value="buka_puasa" {{ old('event_type') === 'buka_puasa' ? 'selected' : '' }}>🌙 Buka Puasa</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            Preview Image
                            <span class="text-gray-400 font-normal">(jpg, jpeg, png, webp — maks 2MB)</span>
                        </label>
